export const ROOM_TYPES = [
  {
    ...
    buyerLabel: "Hosts, planners, and venues",
    salesPitch: "A QR guestbook that collects better memories than a paper sign-in table.",
    price: "$49 / event",
  ...
  },
  {
    ...
    buyerLabel: "Couples, roommates, and long-distance friends",
    salesPitch: "A shared ritual product, not just another camera filter app.",
    price: "$9 / month",
  ...
  },
  {
    ...
    buyerLabel: "Cafe owners, creators, and retail teams",
    salesPitch: "An on-site photo activation that creates branded UGC without custom event software.",
    price: "$299 / campaign",
...
export const MONETIZATION_PACKAGES = [
  {
    ...
    price: "$49 / event",
    amount: 49,
    billingLabel: "One-time event fee",
    timeline: "Set up in minutes, deliver same day",
    salesLead: "Sell it as the modern guestbook: one QR, one room, one downloadable keepsake.",
  ...
  },
  {
    ...
    price: "$9 / month",
    amount: 9,
    billingLabel: "Monthly recurring",
    timeline: "Habit product with monthly recap",
    salesLead: "Position it as a shared memory ritual that keeps couples and friends coming back.",
  ...
  },
  {
    ...
    price: "$299 / campaign",
    amount: 299,
    billingLabel: "Per campaign / activation",
    timeline: "Pre-event setup with export pack after launch",
    salesLead: "Pitch it as a branded photo booth without the booth hardware.",
...
export const ADD_ONS = [
  {
    ...
    price: "$12",
    amount: 12,
    impact: "Good first upsell when someone wants premium film looks without buying the full campaign tier.",
  ...
  },
  {
    ...
    price: "$18",
    amount: 18,
    impact: "High-intent upgrade for hosts who care about a take-home artifact or printed guestbook.",
  ...
  },
  {
    ...
    price: "$39",
    amount: 39,
    impact: "Best for business buyers who want CTA framing, share cards, and sponsor-ready exports.",
